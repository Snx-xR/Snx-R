...
repo init --depth=1 --no-repo-verify -u https://Sa-Sajjad:$ght@github.com/keepQASSA/manifest -b Q
# replace with your manifest
git clone git@github.com:Sa-Sajjad/manifest.git --depth 1 -b qassa .repo/local_manifests
# sync script
